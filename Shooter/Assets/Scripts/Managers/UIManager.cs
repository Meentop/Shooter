...
public class UIManager : MonoBehaviour
{
    ...
    public void SetActiveSelectableUI(SelectableUI buttonTypes, bool isActive)
    {
        if(!PauseManager.Pause)
            selectablesUI[(int)buttonTypes].SetActive(isActive);
    }

    public bool GetActiveSelectableUI(SelectableUI buttonTypes)
    {
